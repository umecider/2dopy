...
def fetch():
    thing = sql.getall()
    """ 
    FROM CODE BELOW: getall()/fetchall from sql returns all tasks as a list of tuples, values being ordered as they are in the database.
    so list of tuples w/ values (id, name, completed, due date, priority, completion date)
